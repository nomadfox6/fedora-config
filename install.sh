...
link "$REPO/config/hypr/urgent-notify.sh"   "$CONFIG/hypr/urgent-notify.sh"
link "$REPO/config/hypr/expo-toggle.sh"     "$CONFIG/hypr/expo-toggle.sh"
link "$REPO/config/hypr/ws-thumbs.sh"       "$CONFIG/hypr/ws-thumbs.sh"
link "$REPO/config/hypr/ws-capture"         "$CONFIG/hypr/ws-capture"
